...
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_pendaftaran WHERE no_pendaftaran ='$no_pendaftaran'") or die ("SQL Edit error");
        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Tambah Data Penerimaan</h3>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <button type="submit" class="btn btn-success">
                                    <span class="fa fa-save"></span> Simpan Penerimaan</button>
                            </div>
                        </div>
                    </form>
...
if($_POST){
  ...
  $nama_ortu=$_POST['nama_ortu'];
    ...
    //buat sql
    $sql="INSERT INTO tbl_penerimaan VALUES ('',
                                    '$nama_lengkap',
                                    '$no_pendaftaran',
                                    '$tgl_pendaftaran',
                                    '$ttl',
    ...
    $query=  mysqli_query($koneksi, $sql) or die ("SQL Simpan Penerimaan Error");
    if ($query){
